...
class Drink{
    ...
    {
        $jsonData = file_get_contents(Config::datasource().'drinks.json');
    ...
    {
        if(file_exists(Config::datasource().'drinks.json')){
            file_put_contents(Config::datasource().'drinks.json',json_encode($this->data));
            return true;
        }else{
            echo "file not found";
            return false;
