...
class Fastfood{
    ...
    {
        $jsonData = file_get_contents(Config::datasource().'fast_food.json');
    ...
    {
        if(file_exists(Config::datasource().'fast_food.json')){
            file_put_contents(Config::datasource().'fast_food.json',json_encode($this->data));
            return true;
        }else{
            echo "file not found";
            return false;
