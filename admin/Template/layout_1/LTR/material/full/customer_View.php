                ...
                <div class="sidebar-user-material">
                    <div class="sidebar-user-material-body">
                        <div class="card-body text-center">
                            <a href="#">
                                <img src="../../../../global_assets/images/placeholders/kawsar.JPG"
                    ...
                    <ul class="nav nav-sidebar" data-nav-type="accordion">
                        ...
                        <li class="nav-item nav-item-submenu">
                            ...
                            <ul class="nav nav-group-sub" data-submenu-title="Layouts">
                                <li class="nav-item"><a href="add_customer.html" class="nav-link active">Add
                                        Castomer</a></li>
                        ...
                        <li class="nav-item nav-item-submenu">
                            ...
                            <ul class="nav nav-group-sub" data-submenu-title="Layouts">
                                <li class="nav-item"><a href="add_category.html" class="nav-link active">Add
                                        Category</a></li>
                                <li class="nav-item"><a href="categories.html" class="nav-link active">Categories</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item nav-item-submenu">
                            ...
                            <ul class="nav nav-group-sub" data-submenu-title="Layouts">
                                <li class="nav-item"><a href="add_product.html" class="nav-link active">Add Product</a>
                                </li>
                        ...
                        <li class="nav-item nav-item-submenu">
                            ...
                            <ul class="nav nav-group-sub" data-submenu-title="Layouts">
                                <li class="nav-item"><a href="add_outdoor_place.html" class="nav-link active">Add
                                        Outdoor Place</a></li>
                                <li class="nav-item"><a href="outdoor_places.html" class="nav-link active">Outdoor
                                        Places</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item nav-item-submenu">
                            ...
                            <ul class="nav nav-group-sub" data-submenu-title="Layouts">
                                ...
                                <li class="nav-item"><a href="user_roles.html" class="nav-link active">User Roles</a>
                                </li>
                        ...
                        <!-- App Config -->
                        <li class="nav-item nav-item-submenu">
                            <a href="#" class="nav-link"><i class="icon-android mr-3"></i> <span>App
                                    configuration</span></a>

                            <ul class="nav nav-group-sub" data-submenu-title="Layouts">
                                <li class="nav-item"><a href="app_config.html" class="nav-link active">App Config</a>
                                </li>
                                <li class="nav-item"><a href="banner_images.html" class="nav-link active">Banner
                                        Images</a></li>
                                <li class="nav-item"><a href="privecy_policy_page_setup.html"
                                        class="nav-link active">Privecy And Policy Page</a></li>
                                <li class="nav-item"><a href="about_page_setup.html" class="nav-link active">About
                                        Page</a></li>
                            </ul>
                        </li>
                        <!-- /page kits -->
            ...
            <div class="content">
                <section id="customer-details">
                    <div class="customer-details">
                        <div class="image">
                            <img src="<?=$customerView->img?>" height="300px" width="300px" alt="customer image">
                        </div>
                        <div class="details">
                            <h3 style="font-size:35px;padding:0;">Customer Details</h3>
                            <h3 style="font-size:25px;"><?=$customerView->name?></h3>
                            <p>Age : <?=$customerView->age?></p>
                            <p><i class="icon-phone2"></i> <?=$customerView->phone?></p>
                            <p>email : <?=$customerView->email?></p>
                            <p>Address : <?=$customerView->address?></p>
                            <p>User Name : <?=$customerView->username?></p>
                            <p>Passwoard : <?=$customerView->passwoard?></p>
                        </div>
                    </div>
                </section>
            ...
            <div class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="navbar-collapse collapse" id="navbar-footer">
                    <span class="navbar-text">
                        &copy; 2022 - 2023 <a href="#">Campus Canteen</a> by <a href="https://github.com/kawsarsikder01"
                            target="_blank">Kawsar Sikder</a>
                    </span>
