...
<div class="page-content">
    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            ...
            <form action="customerData_Edit_control.php" method="post" enctype="multipart/form-data" >
                <div class="form-group row">
                    <label class="col-form-label col-lg-2">Name<span class="text-danger">*</span></label>
                    <div class="col-lg-10">
                        <input type="text" name = "name" class="form-control" placeholder="Enter your name..." value="<?=$customerEdit->name?>">
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-lg-10">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                        <input type="text" name = "phone" class="form-control" placeholder="Enter phone number..."value="<?=$customerEdit->phone?>">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                        <input type="email" name = "email" class="form-control" placeholder="Enter email address..." value="<?=$customerEdit->email?>">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                        <input type="text" name = "age" class="form-control" placeholder="Enter your age..." value="<?=$customerEdit->age?>">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                        <textarea type="text" name = "address" class="form-control"><?=$customerEdit->address?></textarea>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                        <input type="text" name = "username" class="form-control" placeholder="Enter your user name..."value="<?=$customerEdit->username?>">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                        <input type="passwoard" name ="passwoard" class="form-control" placeholder="Cofirm password..." value="<?=$customerEdit->passwoard?>">
                    </div>
                </div>
