...
$id = $_POST['id'];
$productsJson = file_get_contents($adminSources.'fast_food.json');
...
<div class="page-content">
    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            ...
            <form action="fastFood_edit_control.php" method="post" enctype = "multipart/form-data">
                <div class="form-group row">
                    <label class="col-form-label col-lg-2">Name<span class="text-danger">*</span></label>
                    <div class="col-lg-10">
                        <input type="text" name="name" class="form-control" placeholder="Enter product name..." value="<?=$productData->name?>">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                        <input type="text"name="type" class="form-control" placeholder="Enter product type..."value="<?=$productData->type?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-form-label col-lg-2">Category<span class="text-danger">*</span></label>
                    <div class="col-lg-10">
                        <input type="text"name="category" class="form-control" placeholder="Enter product category..."value="<?=$productData->category?>">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                        <textarea type="text" name="description" class="form-control"><?=$productData->description?></textarea>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                        <input type="text"name="cost-price" class="form-control" placeholder="Enter product cost price..."value="<?=$productData->cost_price?>">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                        <input type="text" name="sell-price" class="form-control" placeholder="Enter product sell price..."value="<?=$productData->sell_price?>">
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-lg-10">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                        <div class="uniform-uploader">
                            ...
                            <img src="<?=$webroot.$productData->img?>"width="50"height="50" alt="">
                            <input type="hidden" name="old_img" value = "<?=$productData->img?>" >
                    ...
                    <div class="col-lg-10">
                        <div class="form-check form-check-switchery form-check-switchery-double">
                            <label class="form-check-label">
                                Enable
                                <input type="checkbox" name="e-sale" class="form-check-input-switchery" checked="Enable" data-fouc="" data-switchery="true" style="display: none;">
                                Disable
                            </label>
                        </div>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                        <div class="form-check form-check-switchery form-check-switchery-double">
                            <label class="form-check-label">
                                Enable
                                <input type="checkbox" name="outdoor" class="form-check-input-switchery" checked="Enable" data-fouc="" data-switchery="true" style="display: none;">
                                Disable
                            </label>
                        </div>
                    </div>
